...
namespace WF
{
    public class MapComponent_WaterFreezes : MapComponent
    {
		...
		public List<string> BreakdownOrDestroyExceptedDefNames = new()
		{
			...
			"skyarkhangel.hsk.FishingPier", //HSK Fishing Pier 
			"skyarkhangel.hsk.CrashedShipWreck", //Crashed Ship Wreck
			"skyarkhangel.hsk.ShipWreck", //HSK Ship Wreck
			"skyarkhangel.hsk.ShipChunk", //HSK Ship Chunk
			"skyarkhangel.hsk.ShipMechChunk", //HSK Ship Mech Chunk
			"skyarkhangel.hsk.DropPodLanded", //HSK Drop Pod
			"skyarkhangel.hsk.PsychicDronerShipPart", //HSK Psychic Droner Ship Part
			"skyarkhangel.hsk.DefoliatorShipPart", //HSK Defoliator Ship Part
		};
